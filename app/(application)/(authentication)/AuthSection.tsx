  ...
  return (
    ...
    >
      <motion.div
        ...
        id="auth-content"
        className="md:order-2 order-1 w-full md:w-1/2 flex flex-col md:px-4 gap-y-4"
      >
        <h2 className="text-3xl md:text-2xl lg:text-3xl font-semibold">
          Yapping
        </h2>
      ...
      <motion.div
        ...
        className="w-full md:w-1/2 md:order-1 order-2  flex flex-col gap-y-4"
      >
        ...
        <div className="w-full h-fit border-2 py-4 px-4 rounded-md border-black">
          {authType == "login" ? (
            ...
            <RegisterAuth changeState={() => changeAuthType()} />
          )}
        </div>
      </motion.div>
    </div>
