    ...
    return (
        ...
        >
          <div className=" w-full flex flex-col items-center h-full relative">
            ...
            {/* Mobile version */}
            <Link className="relative group grid-cols-4 w-full mt-8 h-full lg:hidden grid rounded-md overflow-hidden" href={"/"}>
            <span className="absolute top-0 left-0 bottom-0 right-0 transition-opacity opacity-0 z-[10] group-hover:opacity-100 bg-[rgba(0,0,0,0.5)] justify-center flex items-center font-semibold text-2xl text-white">Explore Now</span>
          ...
          <div className="text-white w-full h-full justify-start lg:justify-center flex flex-col">
            ...
            <p className="mb-8 text-[14px] md:text-base">
              Now you can easily get those kind of things by using our app.
              Don't miss out on exclusive deals and new arrivals tailored to
              your interests. Start exploring now and make your shopping
